            ...
            <div className="flex items-center gap-2">
              ...
              {user?.role === 'admin' && (
                <button
                  ...
                  className="hidden md:inline-flex items-center gap-1 px-3 py-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-xl transition"
